...
<body>
	...
	<input type="search" placeholder="Search">
            ...
            <a href="register.php"><p class="pull-right">0</p></a>
            
            <a href="registration.php"><p class="pull-right hidden-xs">Register</p></a>
            
             <a href="login.php"><p class="pull-right hidden-xs">Sign In</p></a>
